...
import (
	...
	mock_service "github.com/Hanqur/todo_app/pkg/service/mocks"
...
func TestHandler_signUp(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAuthorization, user todo_app.User)

	testTable := []struct {
		name string
		inputBody string
		inputUser todo_app.User
	...
	} {
		{
			...
			mockBehavior: func(s *mock_service.MockAuthorization, user todo_app.User){
